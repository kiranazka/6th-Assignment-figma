      ...
      <section className="py-12 md:py-16 lg:py-0">
        ...
        <div className="mt-16 flex flex-col items-center gap-8 sm:flex-row sm:justify-between">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-6 gap-6 items-center justify-center">
            <Image src="/Image/logo1.svg" alt="Logo 1" width={123} height={38} />
            <Image src="/Image/logo2.svg" alt="Logo 2" width={123} height={38} />
            <Image src="/Image/logo4.svg" alt="Logo 3" width={123} height={38} />
            <Image src="/Image/logo5.svg" alt="Logo 4" width={123} height={38} />
            <Image src="/Image/logo6.svg" alt="Logo 5" width={123} height={38} />
          </div>
        </div>
      </section>
    </div>
